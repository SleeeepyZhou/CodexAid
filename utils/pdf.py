...
os.system('wget https://gitee.com/myhloli/MinerU/raw/dev/scripts/download_models.py --no-check-certificate -O download_models.py')
os.system('python download_models.py')

with open('/root/magic-pdf.json', 'r') as file:
...
with open('/root/magic-pdf.json', 'w') as file:
